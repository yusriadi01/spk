...
Public Class rpt_alternatif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AHP_2018.rpt_alternatif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_alternatif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_alternatif = New rpt_alternatif
        rpt.Site = Me.Site
        Return rpt
    End Function
