...
Public Class rpt_pbkriteria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AHP_2018.rpt_pbkriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_pbkriteria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_pbkriteria = New rpt_pbkriteria
        rpt.Site = Me.Site
        Return rpt
    End Function
