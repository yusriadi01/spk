...
Public Class rpt_subkriteria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AHP_2018.rpt_subkriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_subkriteria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_subkriteria = New rpt_subkriteria
        rpt.Site = Me.Site
        Return rpt
    End Function
